...
const ResetPassword = () => {
  ...
  // Redirect if no resetToken (someone navigated here directly)
  useEffect(() => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#f5f0ff] via-white to-[#ede9fe] flex items-center justify-center px-4">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-[0_8px_30px_rgba(124,58,237,0.12)] p-8 sm:p-10">
        ...
        <h1 className="text-2xl sm:text-3xl font-bold text-gray-800 text-center mb-1">Set New Password</h1>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="relative mb-2">
            <input
              ...
              className="w-full px-4 py-3 pr-11 border-2 border-gray-200 rounded-lg outline-none focus:border-purple-500 transition-colors text-sm"
              autoFocus
            />
            <button
              type="button"
          ...
          <div className="relative mb-6">
            ...
            />
            {form.confirmPassword && form.newPassword === form.confirmPassword && (
              <svg className="w-5 h-5 text-green-500 absolute right-3 top-1/2 -translate-y-1/2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
