...
const UpdatePost = () => {
  ...
  useEffect(() => {
    const fetchPost = async () => {
      try {
        const response = await axiosInstance.get('/posts/findpost', {
          params: { id },
        });
  ...
  const myButtons = [
    "paragraph", "bold", "italic", "underline", "spellcheck",
    "|", "ul", "ol", "|", "link", "image", "fullsize",
  ];
  ...
  const handleCreatePost = async (event) => {
    ...
    const {
      title, companyName, skills, stipend, location, duration, startDate, postDetails,
    } = updatedPost;
    ...
    try {
      const response = await axiosInstance.put('/posts/updatepost', updatedPost, {
        ...
        <form onSubmit={handleCreatePost}>
          <div className="flex flex-col gap-5">
            ...
            <div className="flex flex-wrap gap-5">
              <div className="flex flex-col w-full md:w-1/2">
                <label htmlFor="companyName" className="py-3 font-bold">Company Name</label>
                <input
              ...
              <div className="flex flex-col w-full md:w-1/2">
                <label htmlFor="skills" className="py-3 font-bold">Skills</label>
                <input
                  className="py-3 px-4 border-[#E7E7F1] border-2 outline-none"
                  onChange={handleChange}
                  type="text"
            ...
            <div className="flex flex-wrap gap-5">
              <div className="flex flex-col w-full md:w-1/2">
                <label htmlFor="stipend" className="py-3 font-bold">Stipend</label>
                <input
                  className="py-3 px-4 border-[#E7E7F1] border-2 outline-none"
                  onChange={handleChange}
                  type="number"
              ...
              <div className="flex flex-col w-full md:w-1/2">
                <label htmlFor="location" className="py-3 font-bold">Location</label>
                <input
                  className="py-3 px-4 border-[#E7E7F1] border-2 outline-none"
                  onChange={handleChange}
                  type="text"
            ...
            <div className="flex flex-wrap gap-5">
              <div className="flex flex-col w-full md:w-1/2">
                <label htmlFor="duration" className="py-3 font-bold">Duration</label>
                <input
                  className="py-3 px-4 border-[#E7E7F1] border-2 outline-none"
                  onChange={handleChange}
                  type="text"
              ...
              <div className="flex flex-col w-full md:w-1/2">
                <label htmlFor="startDate" className="py-3 font-bold">Start Date</label>
                <input
                  className="py-3 px-4 border-[#E7E7F1] border-2 outline-none"
                  onChange={handleChange}
                  type="date"
